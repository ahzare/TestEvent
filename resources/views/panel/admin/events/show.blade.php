                                                            ...
                                                            @if($file->type == \App\Utils\FileManager::FILE_TYPE_IMAGE)
                                                                <div class="col-md-12 col-lg-6 col-xl-4">
                                                                    <div class="info-box">
                                                                        ...
                                                                        <div class="info-box-content">
                                                                        <span
                                                                            class="info-box-text">{{$file->title}}</span>
                                                                            <span
                                                                                class="info-box-number">{{$file->desc}}</span>
                                                                            <span
                                                                                class="info-box-number">{{$file->user->email}}</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            @endif
